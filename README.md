...
В нашей CI конфигурации мы используем комбинацию этих подходов, проверяя код на нескольких версиях Python, устанавливая порог качества в 8.0/10 и обеспечивая продолжение пайплайна даже при наличии некритичных предупреждений. 